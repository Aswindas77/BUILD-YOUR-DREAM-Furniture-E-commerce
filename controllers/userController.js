...
const updatePaymentStatus = async (req, res) => {
    try {
        const { orderId, paymentId, razorpaySignature, status } = req.body;
        ...
        if (status === "Paid" && paymentId && razorpaySignature) {
            try {
                const secret = "wehlBhfqQlWoouA0ZGxYB373"; // Your Razorpay secret
